...
// kopium command: kopium --auto --smart-derive-elision --derive PartialEq --derive Default --schema derived servicemonitors.monitoring.coreos.com
...
pub struct ServiceMonitorEndpoints {
    ...
    pub proxy_connect_header:
        Option<BTreeMap<String, Vec<ServiceMonitorEndpointsProxyConnectHeader>>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
...
pub struct ServiceMonitorEndpointsOauth2 {
    ...
    pub proxy_connect_header:
        Option<BTreeMap<String, Vec<ServiceMonitorEndpointsOauth2ProxyConnectHeader>>>,
    #[serde(
        default,
        skip_serializing_if = "Option::is_none",
        rename = "proxyFromEnvironment"
